  ...
  return (
    <HeadProvider>
      <div className="text-white">
        ...
        <Link rel="canonical" href="http://factorygame.org/blueprint/update" />
        <Meta
          name="description"
          content="This is factorygame.org/blueprint/update. Here you can update the Blueprint token with some attributes."
        />
        <Meta
          name="keyword"
