  ...
  return (
    <HeadProvider>
      <div className="text-white">
        ...
        <Meta
          name="keyword"
          content="Factory, Factory1155, Blueprint, Product, Creation"
        />
        <div className="flex justify-between items-center py-3">
          ...
          <h3 className="text-sm fixed bg-[#243e81] rounded-full px-2 py-1 bottom-6 right-6 z-20 xs:text-base lg:text-lg xl:text-xl xs:block xs:static xs:bg-transparent">
            ...
            <span className="hidden xs:inline-block">Available Components</span>
            : <span>{availableComponent}</span>
          </h3>
        </div>
            ...
            {createBlueprint.data.erc20Data.map((erc20, idx) => {
              return (
                <ERC20Card
                  ...
                  icon
                  onEditIconClicked={() =>
                    handleEditERC20CardClicked(erc20, idx)
                  }
                  onDeleteIconClicked={() =>
