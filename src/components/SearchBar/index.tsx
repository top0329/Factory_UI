        ...
        <div className="mt-5 sm:flex sm:items-center">
          ...
          <div className="flex gap-3 mt-2 sm:gap-0 sm:mt-0">
            ...
            <Button
              text="New Blueprint"
              variant="primary"
              className="flex justify-center px-1 py-2 search-button-width rounded-lg border border-primary bg-black font-medium text-light-gray shadow-sm sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm sm:min-w-36"
            />
          </div>
        </div>
      </div>
