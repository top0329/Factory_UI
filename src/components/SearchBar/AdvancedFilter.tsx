    ...
    <div className="flex flex-col py-4 px-4 bg-[#000000]/90 w-[282px] gap-y-4 border rounded-b-lg">
      ...
      <div className="flex flex-col gap-y-2">
        ...
        <div className="flex flex-col gap-2">
          <select
            defaultValue="ETH"
            className="flex w-full items-center px-3 py-1.5 rounded-lg border border-light-gray bg-[#000000] font-medium text-white shadow-sm sm:mt-0 sm:w-auto sm:text-sm sm:min-w-36 sm:gap-3"
          >
            <option>ETH</option>
            <option>USDT</option>
            <option>USDC</option>
