...
const PlatformStatus: FC<Props> = ({
  ...
  return (
    <div className="relative z-20 grid grid-cols-2 px-4 py-12 bg-[#05090c] md:px-10 lg:px-14 xl:px-[86px] xl:py-16 2xl:px-32 2xl:py-20 md:flex md:justify-between">
