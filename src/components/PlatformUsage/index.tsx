  ...
  return (
    <HeadProvider>
      ...
      >
        ...
        <div
          className="grid grid-cols-12 border border-[#16e3e34d] rounded-3xl shadow-lg shadow-secondary bg-[#09080e]"
          data-aos="fade-up"
          data-aos-offset="200"
          data-aos-delay="200"
          data-aos-duration="500"
        ...
        >
          <div
            className="col-span-12 px-3 py-10 gap-4 flex flex-col justify-center items-start md:col-span-6 lg:col-span-7 lg:gap-8 lg:px-10"
            data-aos="fade-right"
            data-aos-offset="200"
            data-aos-delay="200"
            data-aos-duration="500"
          ...
          >
            ...
            >
              ...
              <p className="pl-3 text-white text-lg md:text-xl lg:text-2xl">
                Enhancing Asset Value Stability and Reusablility using Game
                Asset &nbsp;
            ...
            >
              ...
              <p className="pl-3 text-white text-lg md:text-xl lg:text-2xl">
                ...
                <span className="text-yellow">Unique </span>&nbsp; NFTs for
                gaming aseets
              </p>
            </div>
            <div
            ...
            >
              ...
              <p className="pl-3 text-white text-lg md:text-xl lg:text-2xl">
                ...
                &nbsp;by expanding the ways Game Assets can circulate, manage
                and trade
              </p>
            </div>
          </div>
          <div
            className="relative col-span-12 h-full rounded-3xl md:col-span-6 lg:col-span-5"
            data-aos="fade-left"
            data-aos-offset="200"
            data-aos-delay="200"
            data-aos-duration="500"
