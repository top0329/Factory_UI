...
const PlatformUsage: FC = () => {
  return (
    <div className="px-6 py-2  bg-landing shadow-light-gray sm:px-10 sm:py-4 md:px-15 md:py-8 lg:px-20 lg:py-12">
      <h1 className="text-light-gray font-bold text-xl mb-6 sm:mb-8 sm:text-2xl md:mb-10 md:text-3xl lg:mb-14 lg:text-4xl">
      ...
      <div className="grid grid-cols-12 border border-[#16e3e34d] rounded-3xl shadow-lg shadow-secondary bg-[#09080e]">
        ...
        <div className="relative col-span-12 h-full rounded-b-3xl md:col-span-6 lg:col-span-5">
          <div className="absolute w-2/5 h-full bg-gradient-to-r from-landing via-transparent to-transparent rounded-b-3xl md:rounded-3xl"></div>
          <img
            className="w-full h-full object-cover rounded-b-3xl md:rounded-3xl"
