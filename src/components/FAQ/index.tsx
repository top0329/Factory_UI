...
export default function FAQ() {
  return (
    <div className="relative z-20 px-4 py-8 sm:px-10 md:px-15 md:pt-8 md:pb-20 lg:px-20">
      <h1
        className="px-2 py-16 text-white text-center text-[22px] md:text-[30px] lg:text-3xl font-medium"
        data-aos="fade-down"
        data-aos-offset="200"
        data-aos-delay="200"
        ...
        <Accordion
          ...
          content={
            <p className="leading-8 px-1">
              ...
              Blueprint tokens and the corresponding{' '}
        ...
        <Accordion
          ...
          content={
            <p className="leading-8 px-1">
              ...
              technology, dedicated to offering users a unique experience in
              game asset synthesis and management. The platform enables users to
              create new, higher-level game assets, referred to as &quot;Product
              Tokens&quot;, by staking existing digital asset -{' '}
