...
export function UserBlueprintCard(props: Props) {
  return (
    <div
      id="container"
    ...
    >
      <div className="relative w-[176px] sm:w-[280px]">
        ...
        <div
          id="infor"
          className="relative flex flex-wrap justify-between sm:flex-col gap-y-1 top-[2px] sm:top-[-8px] px-6 sm:w-[280px] w-[176px] box-border"
        >
          <div id="name" className="text-white w-1/2">
          ...
          <div id="id_supply" className="flex justify-between text-white">
            <div id="id" className="">
              <p className="text-xs font-mono text-[#858584] w-1/2">ID</p>
          ...
          <Button
            text="Mint Now"
            variant="primary"
            className="w-full mb-3 mt-1 sm:mt-0 rounded-lg justify-center"
          />
        </div>
      </div>
    </div>
