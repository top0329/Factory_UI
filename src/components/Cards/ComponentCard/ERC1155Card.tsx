  ...
  return (
    <div className="relative w-full min-w-[120px] h-[250px] overflow-hidden bg-[#040a0f] border border-black rounded-3xl sm:h-[290px] sm:min-w-[220px]">
      <div className="group relative">
        ...
        <div
          id="badge"
          className="absolute -right-10 top-[10px] w-[150px] h-[24px] bg-[#db00ff] text-white text-center text-base rotate-[38.86deg] py-auto pl-[12px] shadow-[0_3px_5px_1px_rgba(0,0,0,0.3)] sm:h-[30px] sm:text-lg sm:-right-8 sm:top-[17px]"
        >
          ERC1155
        </div>
      </div>
