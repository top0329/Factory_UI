...
const ERC721Card: FC<Props> = ({ id, name, uri, address, icon = false }) => {
  ...
  return (
    <div className="group relative w-auto h-[300px] overflow-hidden border border-black rounded-3xl">
      <div
        id="badge"
        className="absolute left-[152px] top-[17px] w-[150px] h-[30px] bg-[#099ef5] text-white text-center text-[18px] rotate-[38.86deg] py-auto pl-[12px] shadow-[0_3px_5px_1px_rgba(0,0,0,0.3)]"
      >
        ERC721
      </div>
      <img
