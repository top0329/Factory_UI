...
export default function ERC721DecomposeListCard(props: Props) {
  return (
    <div className="flex gap-3 w-[400px] md:w-[80%] h-[80px] justify-between items-center md:px-[40px] py-2 border bg-[#099EF5]/10 border-[#099EF5] rounded-3xl text-white text-base">
